...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Assume_Synchronous_Clk {true} CONFIG.Write_Width_A {72} CONFIG.Write_Depth_A {512} CONFIG.Read_Width_A {72} CONFIG.Operating_Mode_A {READ_FIRST} CONFIG.Write_Width_B {72} CONFIG.Read_Width_B {72} CONFIG.Operating_Mode_B {READ_FIRST} CONFIG.Enable_B {Use_ENB_Pin} CONFIG.Register_PortA_Output_of_Memory_Primitives {false} CONFIG.Register_PortB_Output_of_Memory_Primitives {false} CONFIG.Port_B_Clock {100} CONFIG.Port_B_Enable_Rate {100} CONFIG.Use_Byte_Write_Enable {true} CONFIG.Fill_Remaining_Memory_Locations {true}] [get_ips blockram]
...
set_property -dict [list CONFIG.Input_Data_Width {181} CONFIG.Input_Depth {512} CONFIG.Output_Data_Width {181} CONFIG.Output_Depth {512} CONFIG.Valid_Flag {true} CONFIG.Data_Count_Width {9} CONFIG.Write_Data_Count_Width {9} CONFIG.Read_Data_Count_Width {9} CONFIG.Programmable_Full_Type {Single_Programmable_Full_Threshold_Constant} CONFIG.Full_Threshold_Assert_Value {500} CONFIG.Full_Threshold_Negate_Value {499}] [get_ips page_fifo]
...
set_property -dict [list CONFIG.Memory_Type {Simple_Dual_Port_RAM} CONFIG.Assume_Synchronous_Clk {true} CONFIG.Write_Width_A {72} CONFIG.Write_Depth_A {512} CONFIG.Read_Width_A {72} CONFIG.Operating_Mode_A {NO_CHANGE} CONFIG.Write_Width_B {72} CONFIG.Read_Width_B {72} CONFIG.Operating_Mode_B {READ_FIRST} CONFIG.Enable_B {Use_ENB_Pin} CONFIG.Register_PortA_Output_of_Memory_Primitives {false} CONFIG.Register_PortB_Output_of_Memory_Primitives {true} CONFIG.Port_B_Clock {100} CONFIG.Port_B_Enable_Rate {100}] [get_ips result_ram]
...
set_property -dict [list CONFIG.Fifo_Implementation {Common_Clock_Block_RAM} CONFIG.Input_Data_Width {33} CONFIG.Input_Depth {512} CONFIG.Output_Data_Width {33} CONFIG.Output_Depth {512} CONFIG.Use_Embedded_Registers {false} CONFIG.Almost_Full_Flag {true} CONFIG.Valid_Flag {true} CONFIG.Data_Count {true} CONFIG.Data_Count_Width {9} CONFIG.Write_Data_Count_Width {9} CONFIG.Read_Data_Count_Width {9} CONFIG.Programmable_Full_Type {Single_Programmable_Full_Threshold_Constant} CONFIG.Full_Threshold_Assert_Value {450} CONFIG.Full_Threshold_Negate_Value {449}] [get_ips unsolved_fifo]
